...
const Home = () => {
    return(
        <div className="flex justify-between md:min-h-[40rem] md:w-full py-[1.5rem]">
          ...
          <div className="flex items-center gap-3 md:py-4">
            <div className="md:w-[6rem] w-[4rem] md:h-[1.875rem] h-[4rem]">
              <img className="object-contain w-full h-full" src="../../../public/images/Frame 37.png" />
            </div>
        ...
        <div className=" md:w-[60rem] relative md:block hidden">
          <div className=" w-[10rem] h-[13rem] md:w-[18rem] md:h-[21rem] absolute md:right-[17rem] ">
            <img className="object-contain w-full h-full" src="../../../public/images/Frame 6guy.png" />
          </div>
          <div className=" w-[10rem] h-[13rem] md:w-[18rem] md:h-[21rem] absolute translate-y-3/4 md:right-[3rem] ">
            <img className="object-contain w-full h-full" src="../../../public/images/Frame 7girl.png" />
          </div>
          <div className=" w-[10rem] h-[13rem] md:w-[18rem] md:h-[21rem] absolute translate-y-[20rem] md:right-[18rem]">
            <img className="object-contain w-full h-full" src="../../../public/images/Frame 35media length.png" />
          </div>
        </div>
        </div>
    )
