  ...
  return (
    <section id="pricing">
      <h1 className=" md:text-[2.25rem] text-[1.25rem] font-[600] text-center  md:leading-[3.064rem]">
        Our <span className="text-[#320E3B] font-[700]">pricing</span> is simple
      ...
      <div>
        <div className="flex justify-center p-6">
          <button
            ...
            className={
              isActive == "monthly"
                ? `border-[#320E3B] border-[1px] px-[1.938rem] py-[0.625rem] bg-[#320E3B] text-[#FFFFFF] leading-[1.362rem] text-[1rem] font-[400] rounded-tl-[0.625rem] rounded-bl-[0.625rem]`
                : `border-[#320E3B] border-[1px] px-[1.938rem] py-[0.625rem] text-[#320E3B] leading-[1.362rem] text-[1rem] font-[400] rounded-tl-[0.625rem] rounded-bl-[0.625rem]`
            }
          >
            Monthly
          </button>
          <button
            ...
            className={
              isActive == "yearly"
                ? `border-[#320E3B] border-[1px] px-[1.938rem] py-[0.625rem] bg-[#320E3B] text-[#FFFFFF] leading-[1.362rem] text-[1rem] font-[400] rounded-tr-[0.625rem] rounded-br-[0.625rem]`
                : `border-[#320E3B] border-[1px] px-[1.938rem] py-[0.625rem] text-[#320E3B] leading-[1.362rem] text-[1rem] font-[400] rounded-tr-[0.625rem] rounded-br-[0.625rem]`
            }
          >
            Yearly
          </button>
